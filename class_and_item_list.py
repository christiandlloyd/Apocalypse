...
Apple_studale = {"Healing":8, "Uses": 1}
...
Weapons = ["Sword", "Wand", "Sheild", "Dagger", "Book", "Axe"]
Armor =["Leather", "Iorn", "Steel"]
Consumables = ["Apple","Apple_studale","Apple_pie","Watermelon","Watermelon_smoothy","Watermelon_sorbet"]
